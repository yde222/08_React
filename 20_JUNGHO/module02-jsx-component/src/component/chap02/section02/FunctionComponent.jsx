  ...
  return (
    <div className="container">
      ...
      <section>
        <h2>함수형 컴포넌트 정의</h2>
        <p>
          <strong>함수형 컴포넌트</strong>는 props를 입력으로 받아 React 앨리먼트를 반환하는 JavaScript함수이다. 함수형
          컴포넌트는 간결하고 직관적이며, 최신 React개발의 중심이 되는 방식이다.
        </p>
        <pre>
          {`
            // 기본 함수 선언 방식
      ...
      <section>
        ...
        <p>
          ...
          컴포넌트로 정보를 전달할 때 사용한다. props는 읽기 전용(immutable)이며, 컴포넌트 내부에서 수정할 수 없다.
        </p>
        ...
        <div>
          <h3>실제 props 예제</h3>
          <UserProfile name="지정호" job="개발자" age={30} />
          <UserProfile name="김정호" job="개발자" age={50} />
        </div>
      </section>
      ...
      <section>
        <h2>기본 Props 값 설정</h2>
        <p>
          컴포넌트에 props가 전달되지 않았을 때 사용할 기본값을 설정할 수 있다. 이를 통해 컴포넌트를 더 견고하게 만들 수
          있다.
        </p>
      ...
      <section>
        ...
        <p>
          <strong>children</strong>은 특별한 prop으로, 컴포넌트의 여는 태그와 닫는 태그 사이에 있는 내용을 가리킨다.
          이를 통해 컴포넌트를 더 유연하게 구성할 수 있다.
        </p>
